...
%clex_verb(Formed,Verb,iv,pp):-iv_pp(Formed,Verb).
...
clex_adj_prep(Biggest,Big,Prep,unknown):-adj_tr(Biggest,Big,Prep),not(adj_prep0(Biggest,_,Prep,_)).
...
clex_adj(Biggest,Big,unknown):-adj_itr(Biggest,Big),not(adj_itr0(Biggest,_,_)).
