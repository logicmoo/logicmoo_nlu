...
:-expects_dialect(pfc).
 %  loading(always,'examples/Cassimatis2002/OneScreen.e').
%;
...
% load examples/Cassimatis2002/PolySpace.e
 %  loading(changed,'examples/Cassimatis2002/PolySpace.e').
%;
%; Copyright (c) 2005 IBM Corporation and others.
%; All rights reserved. This program and the accompanying materials
%; are made available under the terms of the Common Public License v1.0
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:38
%; axioms
% [object1,object2]
 % Equal(object1,object2) -> Equal(object2,object1).
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:40
axiom(equal(Object2, Object1),
    [equal(Object1, Object2)]).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:42
%; objects have unique shape
% [object,shape1,shape2]
% Shape(object,shape1) & Shape(object,shape2) ->
% shape1=shape2.
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:45
axiom(Shape1=Shape2,
    [shape(Object, Shape1), shape(Object, Shape2)]).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:47
%; objects have unique color
% [object,color1,color2]
% Color(object,color1) & Color(object,color2) ->
% color1=color2.
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:50
axiom(Color1=Color2,
    [color(Object, Color1), color(Object, Color2)]).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:52
 ...
 */
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:55
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:57
 ...
 */
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:60
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:62
 ...
 */
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:67
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:69
 ...
 */
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:73
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:75
%; objects have locations
% [grid,object,time]
% (
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:77
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:79
...
% Equal(object1,object2).
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:83
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:85
...
%           time).
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:89
axiom(initiates(move(Grid, Object, Xcoord1, Ycoord1, Xcoord2, Ycoord2), location(Grid, Object, Xcoord2, Ycoord2), Time),
    []).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:91
%; moving to a location causes the object no longer to be at its previous
%; location
% [grid,object,xcoord1,ycoord1,xcoord2,ycoord2,time]
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:94
% Terminates(Move(grid,object,xcoord1,ycoord1,xcoord2,ycoord2),
%            Location(grid,object,xcoord1,ycoord1),
%            time).
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:96
axiom(terminates(move(Grid, Object, Xcoord1, Ycoord1, Xcoord2, Ycoord2), location(Grid, Object, Xcoord1, Ycoord1), Time),
    []).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:98
...
% [grid,object,xcoord1,ycoord1,xcoord2,ycoord2,time]
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:111
% Happens(Move(grid,object,xcoord1,ycoord1,xcoord2,ycoord2),time) ->
% HoldsAt(Location(grid,object,xcoord1,ycoord1),time) &
% ((xcoord1=xcoord2 & (ycoord1=ycoord2+1 | ycoord1=ycoord2-1)) |
%  (ycoord1=ycoord2 & (xcoord1=xcoord2+1 | xcoord1=xcoord2-1))).
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:114
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/PolySpace.e:116
%; End of file.
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:27
% Shape(X,Round).
shape(x,round).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:28
% Color(X,Red).
color(x,red).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:29
% Shape(Y,Round).
shape(y,round).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:30
% Color(Y,Red).
color(y,red).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:31
% Shape(Screen,Square).
shape(screen,square).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:32
% Color(Screen,Green).
color(screen,green).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:33
% [time]
 % HoldsAt(Location(G1,Screen,2,0),time).
holds_at(location(g1,screen,2,0),Time).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:34
% HoldsAt(Location(G1,X,1,1),0).
axiom(initially(location(g1, x, 1, 1)),
    []).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:35
% HoldsAt(Location(G1,Y,3,1),2).
holds_at(location(g1,y,3,1),2).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:37
% [xcoord,ycoord,time]
 ...
 */
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:40
axiom(not({dif(X, 2)}),
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:42
% [xcoord,ycoord,time]
 ...
 */
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:45
axiom(not({dif(Y, 2)}),
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:47
% range time 0 2
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:48
==> range(time,0,2).

% range xcoord 0 4
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:49
==> range(xcoord,0,4).

% range ycoord 0 2
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:50
==> range(ycoord,0,2).

% range offset 0 0
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/Cassimatis2002/OneScreen.e:51
==> range(offset,0,0).
%; End of file.
