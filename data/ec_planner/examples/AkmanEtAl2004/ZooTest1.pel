...
:-expects_dialect(pfc).
 %  loading(always,'examples/AkmanEtAl2004/ZooTest1.e').


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:0
%;
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:20
% option encoding 3
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:21
:- set_ec_option(encoding, 3).

% load foundations/Root.e

% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:23
% load foundations/EC.e

% load examples/AkmanEtAl2004/ZooWorld.e
 %  loading(changed,'examples/AkmanEtAl2004/ZooWorld.e').
%;
%; Copyright (c) 2005 IBM Corporation and others.
%; All rights reserved. This program and the accompanying materials
%; are made available under the terms of the Common Public License v1.0
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:25
 ...
 */
 ...
 /*  not(some(Some_Param, '$kolem_Fn_35'(Neighbor_Param))) :-
       (   not({dif(Some_Param, Neighbor_Param)})
       ;   not(neighbor(Neighbor_Param, Some_Param))
       ).
 */
axiom(not(some(Some_Param, '$kolem_Fn_35'(Neighbor_Param))),
    [not({dif(Some_Param, Neighbor_Param)})]).
axiom(not(some(Some_Param, '$kolem_Fn_35'(Neighbor_Param))),
    [not(neighbor(Neighbor_Param, Some_Param))]).
 ...
 /*  { dif(Dif_Param, Dif_Ret)
       ...
       some(Dif_Param, '$kolem_Fn_35'(Dif_Ret)).
 */
axiom({ dif(Dif_Param, Dif_Ret)
 ...
 /*  neighbor(Neighbor_Param7, Some_Param8) :-
       some(Some_Param8, '$kolem_Fn_35'(Neighbor_Param7)).
 */
 ...
 */
 ...
 /*  sides(Sides_Param, Loc_Ret, Some_Param) :-
       ...
       some(Some_Param, '$kolem_Fn_36'(Sides_Param, Loc_Ret)).
 */
axiom(sides(Sides_Param, Loc_Ret, Some_Param),
 ...
 /*  not({dif(loc(Neighbor_Param), loc(Loc_Ret9))}) :-
       ...
       some(Some_Param8, '$kolem_Fn_36'(Neighbor_Param, Loc_Ret9)).
 */
axiom(not({dif(loc(Neighbor_Param), loc(Loc_Ret9))}),
    ...
    [ neighbor(Neighbor_Param, Loc_Ret9),
      not(sides(Neighbor_Param, Loc_Ret9, Some_Param8)),
      some(Some_Param8,
           '$kolem_Fn_36'(Neighbor_Param, Loc_Ret9))
    ]).
 ...
 /*  not(neighbor(Neighbor_Param10, Neighbor_Ret)) :-
       ...
       some(Some_Param11,
            '$kolem_Fn_36'(Neighbor_Param10, Neighbor_Ret)).
 */
axiom(not(neighbor(Neighbor_Param10, Neighbor_Ret)),
 ...
 /*  not(some(Some_Param13, '$kolem_Fn_36'(Fn_36_Param, Fn_36_Ret))) :-
       not(sides(Fn_36_Param, Fn_36_Ret, Some_Param13)),
       { dif(loc(Fn_36_Param), loc(Fn_36_Ret))
       },
       neighbor(Fn_36_Param, Fn_36_Ret).
 */
axiom(not(some(Some_Param13, '$kolem_Fn_36'(Fn_36_Param, Fn_36_Ret))),
 ...
 */
 ...
 /*  holds_at(pos(Pos_Param, Some_Param), Time4) :-
       some(Some_Param, '$kolem_Fn_37'(Pos_Param, Time4)).
 */
axiom(holds_at(pos(Pos_Param, Some_Param), Time4),
    [some(Some_Param, '$kolem_Fn_37'(Pos_Param, Time4))]).

 /*  not(some(Some_Param8, '$kolem_Fn_37'(Fn_37_Param, Time7))) :-
       not(holds_at(pos(Fn_37_Param, Some_Param8), Time7)).
 */
axiom(not(some(Some_Param8, '$kolem_Fn_37'(Fn_37_Param, Time7))),
    [not(holds_at(pos(Fn_37_Param, Some_Param8), Time7))]).
 ...
 */
 ...
 /*  not(some(Some_Param, '$kolem_Fn_43'(Fn_43_Param, Close_Ret, Maptime, Fn_43_Ret))) :-
       happens(close(Fn_43_Param, Close_Ret), Maptime),
       (   not(holds_at(opened(Close_Ret), Maptime))
       ;   holds_at(mounted(Fn_43_Param, Fn_43_Ret), Maptime)
       ;   not(equals(side1(Close_Ret), Some_Param)),
           not(equals(side2(Close_Ret), Some_Param))
       ;   not(holds_at(pos(Fn_43_Param, Some_Param), Maptime))
       ).
 */
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooWorld.e:181
axiom(not(some(Some_Param, '$kolem_Fn_43'(Fn_43_Param, Close_Ret, Maptime, Fn_43_Ret))),
 ...
 */
 ...
 /*  holds_at(mounted(Mounted_Param, Some_Param), Time5) :-
       ...
       some(Some_Param,
            '$kolem_Fn_51'(Mount_Param, Mounted_Param, Time5)).
 */
axiom(holds_at(mounted(Mounted_Param, Some_Param), Time5),
 ...
 /*  not(happens(mount(Mount_Param10, Mounted_Param11), Maptime)) :-
       not(holds_at(mounted(Mounted_Param11, Some_Param12),
                    Maptime)),
       some(Some_Param12,
            '$kolem_Fn_51'(Mount_Param10, Mounted_Param11, Maptime)).
 */
axiom(not(happens(mount(Mount_Param10, Mounted_Param11), Maptime)),
    ...
    [ not(holds_at(mounted(Mounted_Param11, Some_Param12),
                   Maptime)),
      some(Some_Param12,
           '$kolem_Fn_51'(Mount_Param10,
                          Mounted_Param11,
                          Maptime))
    ]).

 /*  not(some(Some_Param14, '$kolem_Fn_51'(Fn_51_Param, Mounted_Param16, Time13))) :-
       not(holds_at(mounted(Mounted_Param16, Some_Param14),
                    Time13)),
       happens(mount(Fn_51_Param, Mounted_Param16), Time13).
 */
axiom(not(some(Some_Param14, '$kolem_Fn_51'(Fn_51_Param, Mounted_Param16, Time13))),
...
% human Homer
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:27
==> t(human,homer).

% elephant Jumbo
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:28
==> t(elephant,jumbo).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:29
% Species(Homer)=HumanSpecies.
species(homer,humanSpecies).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:30
% Adult(Homer).
adult(homer).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:31
% Species(Jumbo)=ElephantSpecies.
species(jumbo,elephantSpecies).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:32
% Adult(Jumbo).
adult(jumbo).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:34
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:35
% HoldsAt(Pos(Homer,6),0).
axiom(initially(pos(homer, 6)),
    []).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:36
% [time]
 % HoldsAt(Pos(Jumbo,1),time).
holds_at(pos(jumbo,1),Time).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:38
%; goal


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:39
% HoldsAt(Mounted(Homer,Jumbo),4).
holds_at(mounted(homer,jumbo),4).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:41
%;ABDUCE
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:47
% HoldsAt(PosDeterminingFluent(human,1),4).
holds_at(posDeterminingFluent(Human,1),4).


% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:48
% [event,animal]
...
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:50
% range time 0 4
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:51
==> range(time,0,4).

% range position 1 8
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:52
==> range(position,1,8).

% range offset 0 0
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:53
==> range(offset,0,0).

% option timediff off
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:55
:- set_ec_option(timediff, off).

% option modeldiff on
% From /opt/logicmoo_workspace/packs_sys/small_adventure_games/prolog/ec_planner/examples/AkmanEtAl2004/ZooTest1.e:56
