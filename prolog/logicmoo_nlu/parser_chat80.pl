...
:- include(logicmoo_nlu_ext(chat80/xgproc)).	% XG generator
...
% :- list('newg.pl').
:- include(logicmoo_nlu_ext(chat80/xgrun)).	% XG runtimes
% :- include(logicmoo_nlu_ext(chat80/newg)).		% clone + lex
...
:- include(logicmoo_nlu_ext(chat80/qplan)).	% query planning
:- include(logicmoo_nlu_ext(chat80/talkr)).	% query evaluation
% :- include(logicmoo_nlu_ext(chat80/ndtabl)).	% relation info.
:- use_module(logicmoo_nlu_ext(chat80/readin)).	% sentence80 input
:- include(logicmoo_nlu_ext(chat80/ptree)).	% print trees
:- include(logicmoo_nlu_ext(chat80/aggreg)).	% aggregation operators


:- include(logicmoo_nlu_ext(chat80/world0)).     	% data base
% :- ensure_loaded(logicmoo_nlu_ext(chat80/world0)).     	% data base

/*
:- include(logicmoo_nlu_ext(chat80/rivers)).
:- include(logicmoo_nlu_ext(chat80/cities)).
:- include(logicmoo_nlu_ext(chat80/countries)).
:- include(logicmoo_nlu_ext(chat80/contain)).
:- include(logicmoo_nlu_ext(chat80/borders)).
*/

% testing
:- include(logicmoo_nlu_ext(chat80/newtop)).	% top level
